...
dirPath = r"/storage/emulated/0/CA/_moje pokusy/CELULAR_AUTOMAT-2D/IMG-sequence/"
loadPath = r"/storage/emulated/0/CA/_moje pokusy/CELULAR_AUTOMAT-2D/interesting/"
CSV_logPath = r"/storage/emulated/0/CA/_moje pokusy/CELULAR_AUTOMAT-2D/CSV_log/IMG-sequence-r/"
writeLogFile = True
...
def createImgCollection(inCA, inDirPath):
    ...
    gap = 60
    headTextFontSize = 13
    headText = "CA2D2r_" + str(startPos) + "-" + str(endPos) + "_" + str(resX) + "x" + str(resY) + "x" + str(cols) 
    ruleTextFontSize = 15
