...
def run(inResX, inResY, inLayCount, inMyRule, inDirPath, inGenerateRandom, inShiftDir, inRndBaseRule):
    ...
    print "CURRENT RULE: \n" + sourceRule
    slashChar = r"/"
    finalDirPath = inDirPath + "CA2D2r_" + sourceRule + "_" + resXstr + "x" + resYstr + slashChar
...
loadPath = dirPath = r"/storage/emulated/0/CA/_moje pokusy/CELULAR_AUTOMAT-2D/interesting/"
...
shiftDir = "N"
rndBaseRule = 0
myRule = "01000000000000001000000000000000"
