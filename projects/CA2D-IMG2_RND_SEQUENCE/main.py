...
dirPath = r"C:/_WORK/PYTHON/CELULAR_AUTOMAT-2D/RND-sequence/"
...
myRule = "01100011100001111111010111101000"
...
def createImgCollection(inCA, inDirPath):
    ...
    headText = "CA2D2_" + str(int(myHeadRule, 2)) + "_" + str(myHeadRule) + "_" + str(resX) + "x" + str(resY) + "x" + str(cols) 
    ruleTextFontSize = 15
    ...
    canvas = Image.new('RGBA', (canvasXsize, canvasYsize), (0,0,0,255))
