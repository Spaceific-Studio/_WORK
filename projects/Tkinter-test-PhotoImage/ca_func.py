...
##        imD.text((orderTextX, orderTextY), str(i), font=orderTextFont, fill=(80,80,80,255))
        ...
        myHSLcol = "hsl(" + str(int(remap(myOcurencesCount[i], 0, maxOcurenceValue, 0, 185))) + ",100%, " + str(int(remap(myOcurencesCount[i], 0, maxOcurenceValue, 30, 70))) + "%)"
        orderTextColComponent = int(255*0.35)
...
def getSym2axisGroup():
    sym2AxisG = [40,56,68,84,108,124,130,
...
def getAsymetryGroups():
    asymG = [[],
             [],
             [[3,36,72,384],[6,9,192,288],
              [12,96,129,258],[33,66,132,264]],
             [[13,193,262,352],[14,137,224,290],
              [19,52,88,400],[22,25,208,304],
              [28,112,145,274],[35,74,164,392],
              [37,67,328,388],[41,134,194,296],
              [44,104,131,386],[49,82,148,280],
              [70,196,265,289],[76,100,259,385]],
             [[15,201,294,480],[29,209,278,368],
              [30,153,240,306],[39,75,420,456],
              [43,166,202,424],[46,139,232,418],
              [51,90,180,408],[53,83,344,404],
              [57,150,210,312],[60,147,120,402],
              [71,293,329,452],[77,263,356,449],
              [86,212,281,305],[92,116,275,401],
              [99,165,330,396],[101,323,332,389],
              [106,163,172,394],[141,225,270,354],
              [142,169,226,298],[197,269,326,353]],
