...
CSV_logPath = r"/storage/emulated/0/CA/_moje pokusy/CELULAR_AUTOMAT-2D/CSV_log/SWITCH-sequence/"
writeLogFile = True
generateRandom = False
invertedRule = False
shiftDir = "N"
rndBaseRule = 0
myIntRule = 1961142663
...
def createImgCollection(inCA, inDirPath):
    ...
    gap = 60
    headTextFontSize = 13
    headText = "CA2D2_" + str(int(myRule, 2)) + "_" + str(myRule) + "_" + str(resX) + "x" + str(resY) + "x" + str(cols) 
    ruleTextFontSize = 15
