...
# Cesta, kterou jsi našel (uprav podle potřeby, pokud by se lišila pro gradio-pdf)
#custom_path = r"C:\Users\GercakD\AppData\Local\Programs\Python\Python310\Lib\site-packages\gradio\templates\frontend\assets"

#def mount_custom_assets(app):
#    if os.path.exists(custom_path):
#        # Namontujeme vnitřní soubory PDF komponenty přímo do FastAPI
#        app.mount("/custom_component/1e8628ddd68ac35b0506c007ccf350f642bff3c588aa11a093990436d3b5a9c5", 
#                  StaticFiles(directory=custom_path), 
#                  name="custom_pdf_fix")
#        print("✅ Ruční mapování PDF komponenty aktivováno.")
        
#import gradio_pdf
# Tento řádek vynutí, aby se komponenta inicializovala dříve, než se sestaví UI
#print(f"Gradio PDF path: {gradio_pdf.__file__}")
...
def main(ctx,
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(variant='panel', scale=5):
                ...
                doc_show = gr.HTML(visible=False)
    ...
    if IS_GRADIO_6:
        ...
        _launch_kwargs = {"footer_links": footer_links, "share" : False}
    else:
