...
try:
    from kreuzberg import extract_file, ExtractionConfig, OcrConfig, OutputFormat
except ImportError:
    extract_file = None
        ...
        try:
            ...
            if mode == "ocr_pdf":
                ...
                txt = pymupdf4llm.to_markdown(
                    ...
                    write_images=True,           # Povolení zápisu obrázků[cite: 5]
                    image_path=img_rel_path,     # Relativní cesta v MD souboru[cite: 5]
                    image_folder=img_full_path   # Fyzická cesta na disku[cite: 5]
                )
