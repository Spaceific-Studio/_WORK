...
#Script for extracting elements by BuiltInParameter for dynamo script Copy_Parameter_Value.dyn.dyn
#resource_path: H:\_WORK\PYTHON\REVIT_API\DYNAMO\getAllElementsWithParameter_D.py
